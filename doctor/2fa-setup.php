<?php
// medecin/2fa-setup.php - Configuration 2FA pour le médecin
session_start();
...
<head>
    ...
    <title>Configuration 2FA - Médecin</title>
        ...
        <div class="container-2fa">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <a href="settings.php" class="btn-secondary">← Retour aux paramètres</a>
                    </div>
