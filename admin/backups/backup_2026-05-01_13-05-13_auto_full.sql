-- Backup created on 2026-05-01 13:05:13
...
CREATE TABLE `attendances` (
  ...
  CONSTRAINT `attendances_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `bed_management` VALUES('1','R-1','B-101','standard','available',NULL,NULL,NULL,NULL);
INSERT INTO `bed_management` VALUES('2','R-1','B-102','standard','occupied','2','2026-04-20 23:46:35',NULL,NULL);
INSERT INTO `bed_management` VALUES('3','R-1','B-103','standard','occupied','1','2026-04-21 14:27:40',NULL,NULL);
INSERT INTO `bed_management` VALUES('4','R-2','B-201','','available',NULL,NULL,NULL,NULL);
INSERT INTO `bed_management` VALUES('5','R-2','B-202','','occupied',NULL,NULL,NULL,NULL);
INSERT INTO `bed_management` VALUES('6','R-2','B-203','','available',NULL,NULL,NULL,NULL);
INSERT INTO `bed_management` VALUES('7','R-3','B-301','pediatric','occupied',NULL,NULL,NULL,NULL);
INSERT INTO `bed_management` VALUES('8','R-3','B-302','pediatric','available',NULL,NULL,NULL,NULL);
INSERT INTO `bed_management` VALUES('9','R-3','B-303','pediatric','available',NULL,NULL,NULL,NULL);
...
INSERT INTO `cleaning_tasks` VALUES('1','2','R-1','chambre','daily','high','completed',NULL,'2026-04-20 23:45:41',NULL,NULL,'2026-04-20 23:45:37');
INSERT INTO `cleaning_tasks` VALUES('2','1','R-1','chambre','daily','high','pending',NULL,NULL,NULL,NULL,'2026-04-21 14:27:27');
...
CREATE TABLE `departments` (
  ...
  CONSTRAINT `departments_ibfk_1` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `departments` VALUES('1','Médecine Générale','Service de médecine générale',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('2','Cardiologie','Service de cardiologie',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('3','Pédiatrie','Service de pédiatrie',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('4','Urgences','Service des urgences',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('5','Administration','Service administratif',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('6','Laboratoire','Laboratoire d\'analyses médicales',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('7','Radiologie','Service de radiologie et imagerie',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('8','Chirurgie','Service de chirurgie générale',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('9','Gynécologie','Service de gynécologie-obstétrique',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('10','Pharmacie','Service pharmaceutique',NULL,'1','2026-04-22 23:27:41');
INSERT INTO `departments` VALUES('11','Médecine Générale','Service de médecine générale',NULL,'1','2026-04-23 01:29:53');
INSERT INTO `departments` VALUES('12','Cardiologie','Service de cardiologie',NULL,'1','2026-04-23 01:29:53');
INSERT INTO `departments` VALUES('13','Pédiatrie','Service de pédiatrie',NULL,'1','2026-04-23 01:29:53');
INSERT INTO `departments` VALUES('14','Urgences','Service des urgences',NULL,'1','2026-04-23 01:29:53');
INSERT INTO `departments` VALUES('15','Administration','Service administratif',NULL,'1','2026-04-23 01:29:53');
INSERT INTO `departments` VALUES('16','Laboratoire','Laboratoire d\'analyses médicales',NULL,'1','2026-04-23 01:29:53');
INSERT INTO `departments` VALUES('17','Radiologie','Service de radiologie et imagerie',NULL,'1','2026-04-23 01:29:53');
...
INSERT INTO `doctors` VALUES('3','20','5','2500.00','C101','Cardiologie','available','Français, Anglais, Arabe','12','Cardiologue expérimenté, spécialiste des maladies cardiovasculaires','2026-04-23 01:25:26','2026-04-23 01:25:26');
INSERT INTO `doctors` VALUES('4','21','38','2000.00','P205','Pédiatrie','available','Français, Arabe','8','Pédiatre dévouée, passionnée par la santé des enfants','2026-04-23 01:25:26','2026-04-23 01:25:26');
INSERT INTO `doctors` VALUES('5','2','18','1500.00','G110','Médecine Générale','available','Français, Arabe, Anglais','10','Médecin généraliste expérimenté','2026-04-23 01:25:26','2026-04-23 01:25:26');
INSERT INTO `doctors` VALUES('20','20','5','2500.00','C101','Cardiologie','available',NULL,'12','Cardiologue expérimenté','2026-04-23 01:28:45','2026-04-23 01:28:45');
INSERT INTO `doctors` VALUES('21','21','38','2000.00','P205','Pédiatrie','available',NULL,'8','Pédiatre dévouée','2026-04-23 01:28:45','2026-04-23 01:28:45');
...
CREATE TABLE `employee_assignments` (
  ...
  CONSTRAINT `employee_assignments_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `employee_assignments_ibfk_2` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `employee_assignments` VALUES('1','4','2','medcin','2026-04-23','2026-04-23','0','2026-04-22 23:35:56');
INSERT INTO `employee_assignments` VALUES('2','4','2','medcin','2026-03-06','2026-04-18','1','2026-04-22 23:36:31');
INSERT INTO `employee_assignments` VALUES('3','2','1','Médecin Chef','2024-01-01',NULL,'1','2026-04-23 01:30:04');
INSERT INTO `employee_assignments` VALUES('4','4','4','Infirmier Principal','2024-01-01',NULL,'1','2026-04-23 01:30:04');
INSERT INTO `employee_assignments` VALUES('5','7','5','Secrétaire Médicale','2024-01-01',NULL,'1','2026-04-23 01:30:04');
INSERT INTO `employee_assignments` VALUES('6','20','2','Cardiologue Senior','2024-01-01',NULL,'1','2026-04-23 01:30:04');
INSERT INTO `employee_assignments` VALUES('7','21','3','Pédiatre','2024-01-01',NULL,'1','2026-04-23 01:30:04');
INSERT INTO `employee_assignments` VALUES('8','25','17','tra','2026-04-23','2026-04-30','1','2026-04-23 21:40:16');
...
INSERT INTO `employee_contracts` VALUES('1','19','stage','2026-04-23','2026-04-30','60000.00','infemier','jsp',NULL,'2026-04-23 00:13:15');
INSERT INTO `employee_contracts` VALUES('2','2','CDI','2020-01-01',NULL,'150000.00','Médecin Chef','Médecine Générale',NULL,'2026-04-23 01:30:15');
INSERT INTO `employee_contracts` VALUES('3','4','CDI','2021-06-01',NULL,'80000.00','Infirmier Principal','Urgences',NULL,'2026-04-23 01:30:15');
INSERT INTO `employee_contracts` VALUES('4','7','CDI','2022-03-01',NULL,'55000.00','Secrétaire Médicale','Administration',NULL,'2026-04-23 01:30:15');
INSERT INTO `employee_contracts` VALUES('5','20','CDI','2019-01-01',NULL,'200000.00','Cardiologue Senior','Cardiologie',NULL,'2026-04-23 01:30:15');
INSERT INTO `employee_contracts` VALUES('6','21','CDD','2024-01-01','2024-12-31','120000.00','Pédiatre','Pédiatrie',NULL,'2026-04-23 01:30:15');
...
CREATE TABLE `employee_documents` (
  ...
  CONSTRAINT `employee_documents_ibfk_2` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `employee_documents` VALUES('1','17','other','Lab1.7.docx','../uploads/rh_documents/doc_17_1776902373_3349.docx','20181','0','18','2026-04-22 23:59:33');
...
INSERT INTO `external_labs` VALUES('1','BioLab Paris','Dr. Martin','0145678901','contact@biolab-paris.fr','123 Rue de la Santé, 75010 Paris',NULL,'1');
INSERT INTO `external_labs` VALUES('2','MediTest Lyon','Sophie Bernard','0478901234','contact@meditest-lyon.fr','45 Avenue des Analyses, 69003 Lyon',NULL,'1');
INSERT INTO `external_labs` VALUES('3','Eurofins Marseille','Pierre Durand','0491234567','marseille@eurofins.fr','78 Boulevard Scientifique, 13008 Marseille',NULL,'1');
INSERT INTO `external_labs` VALUES('4','Labo Sud Toulouse','Isabelle Petit','0567890123','contact@labosud-toulouse.fr','12 Rue des Biologistes, 31000 Toulouse',NULL,'1');
INSERT INTO `external_labs` VALUES('5','NordLab Lille','Thomas Leroy','0321456789','contact@nordlab-lille.fr','9 Place du Laboratoire, 59000 Lille',NULL,'1');
...
INSERT INTO `financial_reports` VALUES('1','monthly','2026-04-01','150000.00','85000.00','65000.00',NULL,'17','2026-04-23 01:34:45');
INSERT INTO `financial_reports` VALUES('2','weekly','2026-04-16','35000.00','20000.00','15000.00',NULL,'17','2026-04-23 01:34:45');
...
INSERT INTO `invoice_items` VALUES('3','3','Consultation spécialiste','1','2500.00','2500.00');
INSERT INTO `invoice_items` VALUES('4','3','Petite chirurgie','1','5000.00','5000.00');
INSERT INTO `invoice_items` VALUES('5','16','Consultation générale','1','9000.00','9000.00');
INSERT INTO `invoice_items` VALUES('6','16','Vaccination','1','1000.00','1000.00');
INSERT INTO `invoice_items` VALUES('7','16','trai','1','90.00','90.00');
...
INSERT INTO `invoices` VALUES('3','INV-20260423-5435','2',NULL,NULL,'7500.00','7500.00','paid','2026-04-23',NULL,'','2026-04-23 00:54:33','2026-04-23 00:54:55');
INSERT INTO `invoices` VALUES('8','INV-20260001','1',NULL,NULL,'1500.00','1500.00','paid','2026-04-18',NULL,'Consultation générale','2026-04-23 01:32:15','2026-04-23 01:32:15');
INSERT INTO `invoices` VALUES('9','INV-20260002','2',NULL,NULL,'2500.00','2500.00','paid','2026-04-20',NULL,'Consultation cardiologue','2026-04-23 01:32:15','2026-04-23 01:32:15');
INSERT INTO `invoices` VALUES('10','INV-20260003','1',NULL,NULL,'3500.00','3500.00','paid','2026-04-23',NULL,'Échographie + Consultation','2026-04-23 01:32:15','2026-04-23 20:12:43');
INSERT INTO `invoices` VALUES('16','INV-20260423-4012','1',NULL,NULL,'10090.00','1000.00','unpaid','2026-04-23',NULL,'tese','2026-04-23 20:17:38','2026-04-23 20:23:38');
...
CREATE TABLE `lab_inventory_movements` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `lab_inventory_movements_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `lab_inventory` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `lab_stock` VALUES('1','Tubes EDTA (violet)','Consommables',NULL,'500.00','pièces','50.00','Armoire A1','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('2','Tubes sec (rouge)','Consommables',NULL,'300.00','pièces','30.00','Armoire A1','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('3','Aiguilles 21G','Consommables',NULL,'199.00','pièces','20.00','Armoire A2','2026-04-21 22:01:15','2026-04-21 22:37:50');
INSERT INTO `lab_stock` VALUES('4','Alcool 70°','Désinfectant',NULL,'10.00','litres','2.00','Réserve','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('5','Gants latex M','Consommables',NULL,'50.00','boîtes','5.00','Armoire B1','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('6','Réactif glycémie','Réactifs',NULL,'20.00','flacons','3.00','Réfrigérateur 1','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('7','Réactif NFS','Réactifs',NULL,'15.00','flacons','2.00','Réfrigérateur 1','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('8','Bandelettes urine','Consommables',NULL,'100.00','pièces','10.00','Armoire B2','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('9','Pipettes Pasteur','Consommables',NULL,'300.00','pièces','50.00','Armoire A3','2026-04-21 22:01:15','2026-04-21 22:01:15');
INSERT INTO `lab_stock` VALUES('10','Lames porte-objet','Consommables',NULL,'200.00','pièces','25.00','Armoire A3','2026-04-21 22:01:15','2026-04-21 22:01:15');

DROP TABLE IF EXISTS `lab_stock_movements`;
...
INSERT INTO `lab_stock_movements` VALUES('1','3','remove','1.00','','6','2026-04-21 22:37:50');

DROP TABLE IF EXISTS `lab_test_consumables`;
CREATE TABLE `lab_test_consumables` (
  ...
  KEY `test_id` (`test_id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `lab_test_consumables_ibfk_1` FOREIGN KEY (`test_id`) REFERENCES `lab_tests` (`id`),
  CONSTRAINT `lab_test_consumables_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `lab_inventory` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `leave_requests` VALUES('1','4','annual','2026-04-28','2026-05-03','Vacances familiales','approved','18','2026-04-23 01:29:43');
INSERT INTO `leave_requests` VALUES('2','2','sick','2026-04-24','2026-04-25','Grippe','approved',NULL,'2026-04-23 01:29:43');
INSERT INTO `leave_requests` VALUES('3','7','unpaid','2026-05-08','2026-05-13','Affaires personnelles','pending',NULL,'2026-04-23 01:29:43');
INSERT INTO `leave_requests` VALUES('4','20','annual','2026-05-23','2026-05-28','Congés annuels','approved',NULL,'2026-04-23 01:29:43');
...
INSERT INTO `login_logs` VALUES('34','11','amanilakehal4777@gmail.com','2026-04-28 13:43:48','::1','1');
INSERT INTO `login_logs` VALUES('35','18','linou@local.dz','2026-04-28 13:44:48','::1','1');
INSERT INTO `login_logs` VALUES('36','15','1@gmail.com','2026-04-28 13:49:15','::1','1');
INSERT INTO `login_logs` VALUES('37','15','1@gmail.com','2026-04-28 13:51:05','::1','1');
INSERT INTO `login_logs` VALUES('38','11','amanilakehal4777@gmail.com','2026-04-28 14:03:47','::1','1');
INSERT INTO `login_logs` VALUES('39','11','amanilakehal4777@gmail.com','2026-04-28 14:04:05','::1','1');
INSERT INTO `login_logs` VALUES('40','11','amanilakehal4777@gmail.com','2026-04-28 14:25:01','::1','1');
INSERT INTO `login_logs` VALUES('41','26','pharm@local.dz','2026-04-28 14:26:22','::1','1');
INSERT INTO `login_logs` VALUES('42','18','rh@local.dz','2026-04-28 14:27:19','::1','1');
INSERT INTO `login_logs` VALUES('43','17','djam@local.dz','2026-04-28 14:27:52','::1','1');
INSERT INTO `login_logs` VALUES('44','11','amanilakehal4777@gmail.com','2026-04-28 14:28:23','::1','1');
INSERT INTO `login_logs` VALUES('45','27','gestMoy@local.dz','2026-04-28 14:31:34','::1','1');
INSERT INTO `login_logs` VALUES('46','15','1@gmail.com','2026-04-28 14:32:18','::1','1');
INSERT INTO `login_logs` VALUES('47','11','amanilakehal4777@gmail.com','2026-04-28 14:33:28','::1','1');
INSERT INTO `login_logs` VALUES('48',NULL,'labo@gmail.com','2026-04-28 14:34:54','::1','0');
INSERT INTO `login_logs` VALUES('49','28','labo@local.dz','2026-04-28 14:35:06','::1','1');
INSERT INTO `login_logs` VALUES('50','27','gestMoy@local.dz','2026-04-28 14:51:13','::1','1');
INSERT INTO `login_logs` VALUES('51','11','amanilakehal4777@gmail.com','2026-04-28 14:53:15','::1','1');
INSERT INTO `login_logs` VALUES('52','11','amanilakehal4777@gmail.com','2026-04-28 15:31:25','::1','1');
INSERT INTO `login_logs` VALUES('53','26','pharm@local.dz','2026-04-28 15:32:04','::1','1');
INSERT INTO `login_logs` VALUES('54','18','rh@local.dz','2026-04-28 15:34:53','::1','1');
INSERT INTO `login_logs` VALUES('55','15','1@gmail.com','2026-04-28 15:37:00','::1','1');
INSERT INTO `login_logs` VALUES('56','27','gestMoy@local.dz','2026-04-30 21:13:11','::1','1');
INSERT INTO `login_logs` VALUES('57','11','amanilakehal47@gmail.com','2026-05-01 12:10:19','::1','1');
INSERT INTO `login_logs` VALUES('58','11','amanilakehal47@gmail.com','2026-05-01 12:15:40','::1','1');
INSERT INTO `login_logs` VALUES('59','11','amanilakehal47@gmail.com','2026-05-01 12:15:52','::1','1');
INSERT INTO `login_logs` VALUES('60','15','1@gmail.com','2026-05-01 12:15:58','::1','1');
INSERT INTO `login_logs` VALUES('61','11','amanilakehal47@gmail.com','2026-05-01 12:18:18','::1','1');
INSERT INTO `login_logs` VALUES('62','11','amanilakehal47@gmail.com','2026-05-01 12:29:59','::1','1');
INSERT INTO `login_logs` VALUES('63','11','amanilakehal47@gmail.com','2026-05-01 12:33:39','::1','1');
INSERT INTO `login_logs` VALUES('64','11','amanilakehal47@gmail.com','2026-05-01 12:56:11','::1','1');
INSERT INTO `login_logs` VALUES('65','11','amanilakehal47@gmail.com','2026-05-01 12:56:58','::1','1');
INSERT INTO `login_logs` VALUES('66','11','amanilakehal47@gmail.com','2026-05-01 12:57:16','::1','1');
...
INSERT INTO `logs` VALUES('6','1','CREATE_USER','users','17','::1',NULL,NULL,'2026-04-21 16:10:59');
INSERT INTO `logs` VALUES('7','1','CREATE_USER','users','18','::1',NULL,NULL,'2026-04-21 16:12:08');
INSERT INTO `logs` VALUES('8','18','APPROVE_LEAVE','leave_request','3',NULL,NULL,NULL,'2026-04-23 01:34:32');
INSERT INTO `logs` VALUES('9','17','RECORD_PAYMENT','invoice','4',NULL,NULL,NULL,'2026-04-23 01:34:32');
INSERT INTO `logs` VALUES('10','1','CREATE_USER','users','20',NULL,NULL,NULL,'2026-04-22 01:34:32');
INSERT INTO `logs` VALUES('11','1','CREATE_USER','users','26','::1',NULL,NULL,'2026-04-23 01:42:16');
INSERT INTO `logs` VALUES('12','1','CREATE_USER','users','27','::1',NULL,NULL,'2026-04-28 14:31:10');
INSERT INTO `logs` VALUES('13','1','CREATE_USER','users','28','::1',NULL,NULL,'2026-04-28 14:34:12');
INSERT INTO `logs` VALUES('14','1','EDIT_USER','users','11','::1',NULL,NULL,'2026-05-01 12:30:17');
INSERT INTO `logs` VALUES('15','1','EDIT_USER','users','11','::1',NULL,NULL,'2026-05-01 12:37:54');
...
INSERT INTO `medicines` VALUES('1','Doliprane 1000mg','Paracétamol',NULL,'0',NULL,'Antalgique','comprimé','1000mg','500','boîte','2025-12-31','10','50.00','80.00','1','2026-04-23 01:33:57','2026-04-23 01:33:57');
INSERT INTO `medicines` VALUES('2','Augmentin 1g','Amoxicilline + Acide clavulanique',NULL,'0',NULL,'Antibiotique','comprimé','1g','200','boîte','2026-10-31','10','120.00','180.00','1','2026-04-23 01:33:57','2026-04-23 15:35:01');
INSERT INTO `medicines` VALUES('3','Ventoline','Salbutamol',NULL,'0',NULL,'Bronchodilatateur','inhalateur','100mcg','50','boîte','2025-08-31','10','200.00','300.00','1','2026-04-23 01:33:57','2026-04-23 01:33:57');
INSERT INTO `medicines` VALUES('4','first_try','dwa',NULL,'0',NULL,'Antihistaminique','comprimé','500mg','20','gélule','0000-00-00','10','270.00','300.00','1','2026-04-23 19:43:26','2026-04-28 14:51:51');
...
INSERT INTO `notifications` VALUES('1','18','Nouvelle demande de congé','Une nouvelle demande de congé est en attente de validation','info','0',NULL,'2026-04-23 01:34:21');
INSERT INTO `notifications` VALUES('2','17','Facture payée','La facture INV-20260001 a été payée','success','0',NULL,'2026-04-23 01:34:21');
INSERT INTO `notifications` VALUES('3','2','Rappel rendez-vous','Vous avez un rendez-vous dans 30 minutes','warning','0',NULL,'2026-04-23 01:34:21');
...
CREATE TABLE `operating_rooms` (
  ...
  KEY `idx_current_patient` (`current_patient_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `operating_rooms` VALUES('1','OR-01','Bloc A - Salle 1','standard','available','Arthroscope, C-arm, Monitor, Anesthésie',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-04-30 21:11:11','2026-04-30 21:11:11');
INSERT INTO `operating_rooms` VALUES('2','OR-02','Bloc A - Salle 2','standard','in_use','Arthroscope, C-arm, Monitor, Anesthésie, Navigation 3D',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-04-30 21:11:11','2026-04-30 21:11:11');
INSERT INTO `operating_rooms` VALUES('3','OR-03','Bloc B - Urgences','urgences','available','Matériel d\'urgence, Monitor, Défibrillateur',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-04-30 21:11:11','2026-04-30 21:11:11');
INSERT INTO `operating_rooms` VALUES('4','OR-04','Bloc C - Cardiologie','cardiologie','maintenance','Pompe cardio-pulmonaire, Monitor cardiaque, Échographe',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-04-30 21:11:11','2026-04-30 21:11:11');
INSERT INTO `operating_rooms` VALUES('5','OR-05','Bloc D - Neurochirurgie','neurochirurgie','sterilization','Microscope opératoire, Neuronavigation, Scanner per-op',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-04-30 21:11:11','2026-04-30 21:11:11');
...
INSERT INTO `payments` VALUES('3','3','7500.00','cash',NULL,'2026-04-23 00:54:55','17','');
INSERT INTO `payments` VALUES('4','10','3500.00','cash',NULL,'2026-04-23 20:12:43','17','');
INSERT INTO `payments` VALUES('5','16','1000.00','cash',NULL,'2026-04-23 20:23:38','17','par facilite');
...
INSERT INTO `purchase_orders` VALUES('2','PO-20260423-0792','4','2026-04-23',NULL,'confirmed','180000.00','17','commande');
INSERT INTO `purchase_orders` VALUES('3','PO-20260423-4155','2','2026-04-23',NULL,'pending','7900.00','17',' hkhjh');
...
DROP TABLE IF EXISTS `rh_alerts`;
CREATE TABLE `rh_alerts` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `rh_alerts_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `rh_alerts` VALUES('1','contract_expiry','21','Le contrat de Dr. Fatima Zohra expire dans 30 jours','5','1','2026-04-23 01:34:09');
INSERT INTO `rh_alerts` VALUES('2','leave_request','18','Nouvelle demande de congé en attente','3','0','2026-04-23 01:34:09');
INSERT INTO `rh_alerts` VALUES('3','absence','21','Dr. Fatima Zohra absente aujourd\'hui sans justificatif',NULL,'0','2026-04-23 01:34:09');
...
INSERT INTO `staff_planning` VALUES('1','2','2026-04-23','08:00:00','16:00:00','matin',NULL,'0','scheduled',NULL,'','18','2026-04-22 23:49:26');
INSERT INTO `staff_planning` VALUES('2','2','2026-04-23','08:00:00','16:00:00','matin',NULL,'0','confirmed',NULL,NULL,NULL,'2026-04-23 01:30:47');
INSERT INTO `staff_planning` VALUES('3','4','2026-04-23','08:00:00','16:00:00','matin',NULL,'0','confirmed',NULL,NULL,NULL,'2026-04-23 01:30:47');
INSERT INTO `staff_planning` VALUES('4','7','2026-04-23','08:00:00','16:00:00','matin',NULL,'0','confirmed',NULL,NULL,NULL,'2026-04-23 01:30:47');
INSERT INTO `staff_planning` VALUES('5','20','2026-04-23','10:00:00','18:00:00','soir',NULL,'0','confirmed',NULL,NULL,NULL,'2026-04-23 01:30:47');
INSERT INTO `staff_planning` VALUES('6','21','2026-04-23','08:00:00','16:00:00','matin',NULL,'0','scheduled',NULL,NULL,NULL,'2026-04-23 01:30:47');
INSERT INTO `staff_planning` VALUES('7','2','2026-04-24','16:00:00','00:00:00','soir',NULL,'0','scheduled',NULL,NULL,NULL,'2026-04-23 01:30:47');
INSERT INTO `staff_planning` VALUES('8','4','2026-04-24','00:00:00','08:00:00','nuit',NULL,'0','scheduled',NULL,NULL,NULL,'2026-04-23 01:30:47');
...
INSERT INTO `stock_movements` VALUES('1','2','in','5','retour',NULL,'26','2026-04-23 15:01:17');
INSERT INTO `stock_movements` VALUES('2','2','out','1','distribution',NULL,'26','2026-04-23 15:01:55');
INSERT INTO `stock_movements` VALUES('3','4','in','19','commande',NULL,'26','2026-04-23 19:43:26');
INSERT INTO `stock_movements` VALUES('4','4','in','1','Réapprovisionnement manuel GMG',NULL,'1','2026-04-28 14:51:51');
...
INSERT INTO `suppliers` VALUES('1','Pharmacie Centrale','Mohamed Ali','0555123456','contact@pharmacie.ma','Alger Centre','medicines','1','2026-04-23 01:33:46');
INSERT INTO `suppliers` VALUES('2','MedEquip SARL','Karim Bensaid','0555234567','commercial@medequip.dz','Hydra, Alger','equipment','1','2026-04-23 01:33:46');
INSERT INTO `suppliers` VALUES('3','FoodMed Distribution','Nadia Lounis','0555345678','contact@foodmed.dz','Bab Ezzouar','equipment','1','2026-04-23 01:33:46');
INSERT INTO `suppliers` VALUES('4','djamfood','supp','0789076435','fourniss@gmail.com','constantine ain smara','food','1','2026-04-23 15:12:38');
...
CREATE TABLE `surgery_schedule` (
  ...
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `operating_room_id` (`operating_room_id`),
  KEY `idx_status` (`status`),
  KEY `idx_date` (`scheduled_start`),
  CONSTRAINT `surgery_schedule_ibfk_1` FOREIGN KEY (`operating_room_id`) REFERENCES `operating_rooms` (`id`) ON DELETE CASCADE
...
INSERT INTO `users` VALUES('11','amanilakehal47@gmail.com','$2y$10$fmOLZu5Q90Ca.rIlgHOx4OPV67rvOOrVcD26eYp6N43q7iRYp86vu','Amaniii  pp','1','0000000000',NULL,'1','1','AUSZEE6THV5CXU4C','0',NULL,'2026-05-01 12:57:16','2026-04-11 21:41:13','2026-05-01 12:57:16',NULL);
...
INSERT INTO `users` VALUES('15','1@gmail.com','$2y$10$1xHe3bAvauyTVj8Cs3SlfekMDBNs.Qjyop0ovc6HgSITgttudNJCe','1','7','11111111111111',NULL,'1','0',NULL,'0',NULL,'2026-05-01 12:15:58','2026-04-12 20:43:56','2026-05-01 12:15:58',NULL);
...
INSERT INTO `users` VALUES('17','djam@local.dz','$2y$10$e7J4E.aUxxD/MlVMsoG5wO0xxr7JDrXuTC/uWbaEks4owlopBrx8O','djam','9','0555555555',NULL,'1','0',NULL,'0',NULL,'2026-04-28 14:27:52','2026-04-21 16:10:59','2026-04-28 14:27:52',NULL);
INSERT INTO `users` VALUES('18','rh@local.dz','$2y$10$UH7xwFXNSgz1zZUCKaipCuvmuBHswHD89JbE4Mmi8Tq/GlguZwIdC','rh','8','066666666',NULL,'1','0',NULL,'0',NULL,'2026-04-28 15:34:53','2026-04-21 16:12:08','2026-04-28 15:34:53',NULL);
INSERT INTO `users` VALUES('19','yl.ik@gmail.com','$2y$10$8D7e73lqVY1cy36/eX3ROuoDSbP5629abT1P5yT7g.NBEYKkaFd0S','yalaoui ikram','4','0566789676',NULL,'1','0',NULL,'0',NULL,NULL,'2026-04-23 00:12:24','2026-04-23 00:12:24',NULL);
INSERT INTO `users` VALUES('20','medecin1@clinique.com','$2y$10$examplehash','Dr. Ahmed Benali','2','0555123456','Service Cardiologie','1','0',NULL,'0',NULL,NULL,'2026-04-23 01:25:08','2026-04-23 01:25:08',NULL);
INSERT INTO `users` VALUES('21','medecin2@clinique.com','$2y$10$examplehash','Dr. Fatima Zohra','2','0555234567','Service Pédiatrie','1','0',NULL,'0',NULL,NULL,'2026-04-23 01:25:08','2026-04-23 01:25:08',NULL);
INSERT INTO `users` VALUES('22','infirmier2@clinique.com','$2y$10$examplehash','Karim Boudiaf','4','0555345678','Service Urgences','1','0',NULL,'0',NULL,NULL,'2026-04-23 01:25:08','2026-04-23 01:25:08',NULL);
INSERT INTO `users` VALUES('23','pharmacien2@clinique.com','$2y$10$examplehash','Nadia Lounis','6','0555456789','Pharmacie Centrale','1','0',NULL,'0',NULL,NULL,'2026-04-23 01:25:08','2026-04-23 01:25:08',NULL);
INSERT INTO `users` VALUES('24','labo2@clinique.com','$2y$10$examplehash','Slimane Rahmani','5','0555567890','Laboratoire','1','0',NULL,'0',NULL,NULL,'2026-04-23 01:25:08','2026-04-23 01:25:08',NULL);
INSERT INTO `users` VALUES('25','secouriste@clinique.com','$2y$10$examplehash','Amira Mansouri','19','0555678901','Service Ambulance','1','0',NULL,'0',NULL,NULL,'2026-04-23 01:25:08','2026-04-23 01:25:08',NULL);
INSERT INTO `users` VALUES('26','pharm@local.dz','$2y$10$G/g8uTMTeYL69oUwlhJFoOd8bPOMt.XuIFI7qZwCyhp2SXahNrf/6','pharmacie','6','0555555555',NULL,'1','0',NULL,'0',NULL,'2026-04-28 15:32:04','2026-04-23 01:42:16','2026-04-28 15:32:04',NULL);
INSERT INTO `users` VALUES('27','gestMoy@local.dz','$2y$10$Gg8Ww8Kqrl8vzn/jcQ692.oXlRI.4m6wp.y8iFkvoIFgFCmZheFwm','gestMoy','11','0000000000',NULL,'1','0',NULL,'0',NULL,'2026-04-30 21:13:11','2026-04-28 14:31:10','2026-04-30 21:13:11',NULL);
INSERT INTO `users` VALUES('28','labo@local.dz','$2y$10$r9AZn291Z4ufqoc1e0Uy2O91jkSj52SgjPsWRd5E6lactOln4xrri','labo','5','0000000000',NULL,'1','0',NULL,'0',NULL,'2026-04-28 14:35:06','2026-04-28 14:34:12','2026-04-28 14:35:06',NULL);
