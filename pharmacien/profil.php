...
// === RÉCUPÉRATION DES STATISTIQUES PERSONNELLES ===
// Nombre de mouvements de stock effectués
$stmt = $database->prepare("
    SELECT COUNT(*) as count FROM stock_movements WHERE performed_by = ?
");
$stmt->bind_param('i', $user_id);
$stmt->execute();
$stock_movements = $stmt->get_result()->fetch_assoc()['count'];
...
<head>
    ...
    <title>Mon profil - Pharmacie</title>
            ...
            <div class="profile-sidebar">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p style="font-size: 0.8rem; color: var(--text2);"><?php echo htmlspecialchars($user['email']); ?></p>

                        <div class="profile-stats">
                            <div class="profile-stat">
                                <div class="value"><?php echo $stock_movements; ?></div>
                                <div class="label">Mouvements de stock</div>
                            </div>
                            <div class="profile-stat">
                                <div class="value"><?php echo date('d/m/Y', strtotime($user['created_at'])); ?></div>
                                <div class="label">Membre depuis</div>
                            </div>
                            <div class="profile-stat profile-stat-2fa" style="grid-column: span 2;">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <small style="font-size: 0.65rem; color: var(--text2);">L'email ne peut pas être modifié</small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="activity-detail">
                                        <div class="activity-action">
                                            <?php if ($activity['type'] == 'in'): ?>
                                                Entrée de stock : <?php echo $activity['quantity']; ?> unités
                                            <?php else: ?>
                                                Sortie de stock : <?php echo $activity['quantity']; ?> unités
                                            <?php endif; ?>
                                        </div>
                                        <div class="activity-date">
                                            <?php echo date('d/m/Y H:i', strtotime($activity['movement_date'])); ?>
                                            <?php if ($activity['reason']): ?>
                                                • <?php echo ucfirst($activity['reason']); ?>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
