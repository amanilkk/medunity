...
<head>
    ...
    <title>Configuration 2FA - Laborantin</title>
...
<body>
<?php
// laborantin/2fa-setup.php - Configuration 2FA pour le laborantin
session_start();
...
// Vérifier que c'est un laborantin (ou rediriger)
