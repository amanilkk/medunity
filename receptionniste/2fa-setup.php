<?php
// receptionniste/2fa-setup.php - Configuration 2FA pour le réceptionniste
session_start();
...
// Vérifier que c'est un réceptionniste
...
function generateQRCode($secret, $email) {
    $issuer  = 'MEDUNITY - Réceptionniste';
...
<head>
    ...
    <title>Configuration 2FA - Réceptionniste</title>
    ...
    <div class="page-body">
        <div class="container-2fa">
            <div class="profile-card">
                <div class="card-head">
                    <h3>
                        <span>🔐</span> Authentification à deux facteurs
                    </h3>
                </div>
                <div class="card-body">

                    <?php if ($message): ?>
                        <div class="<?= strpos($message, '✅') !== false ? 'alert-success' : 'alert-error' ?>">
                            <span><?= strpos($message, '✅') !== false ? '✅' : '❌' ?></span>
                    ...
                    <?php if ($user['two_factor_enabled']): ?>
                        ...
                        <div class="alert-success">
                            <span>✅</span> La 2FA est actuellement <strong>activée</strong> sur votre compte.
                        </div>
